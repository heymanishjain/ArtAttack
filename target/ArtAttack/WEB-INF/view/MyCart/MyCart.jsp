                  ...
                  <tbody>
                  	<c:forEach var="mycart" items="${displayMyCart }">
                          <tr>
                            ...
                            <td>
                            <a href="manage_edit_cart_add_quantity?id=${mycart.id }" class="btn btn-default"><em class="fa fa-plus"></em></a>
                            ${mycart.quantity }
                            <a href="manage_edit_cart_less_quantity?id=${mycart.id }" class="btn btn-default"><em class="fa fa-minus"></em></a></td>
                            <td>${mycart.status }</td>
                            <td>${mycart.sum }</td>
                            <td>${mycart.dateadded }</td>
                            <td align="center">
                              <a href="manage_delete_cart?id=${mycart.id }" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                            </td>
                          </tr>
                	</c:forEach>
                	<tr>
                   	...
                   	<tr>
                   		<td style="float:right"><a href="manage_user_checkout" class="btn btn-danger"><em class="fa fa-check"></em>Checkout</a></td>
                   	</tr>
                 </tbody>
        </table>
     </div>
